			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					<div class="symbol symbol-100 mr-5">
						<div class="symbol-label" style="background-image:url('{{URL::asset('images/admin.png')}}')"></div>
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="{{url('logOut')}}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Déconnexion</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<a href="#" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mon Profile</div>
					...
					<a href="#" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mes Messages</div>
					...
					<a href="#" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mes Activites</div>
					...
					<a href="#" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">Mes taches</div>
								<div class="text-muted">Derniers taches et projets</div>
							</div>
						</div>
					</a>
					<!--end:Item-->
